    ...
    return {
      ...
      items: [
        ...
        },
        {
          ...
          name: 'SISENSA',
          imageUrl: 'sisensa',
          status: 'A website that has a responsive presence in-out office for multi-company.',
          tech: 'Laravel 11, Tailwind',
          github: 'https://github.com/alifichwnt/sisensa',
          demo: 'null'
        },
        {
          id: 3,
          ...
          imageUrl: 'dashbanjir',
          status: 'A Semi-Interactive dashboard that shows information about flood recapitulation in Indonesia from 2018-2024',
          tech: 'HTML, CSS, JS Native',
          github: 'https://github.com/alifichwnt/dashboard-visdat-2025',
          demo: 'https://alifichwnt.github.io/dashboard-visdat-2025/'
        },
        {
          id: 4,
          name: 'OGS-Mavias',
          imageUrl: 'mavias',
          status: 'A simple application one-gate-system for Himada Mavias, basically this is my post-project of Object Oriented Programming.',
          tech: 'Java',
          github: 'https://github.com/alifichwnt/OGS_Mavias',
          demo: 'null'
        },
        {
          id: 5,
          name: 'Chatbot-V1',
          imageUrl: 'chatbot',
          status: 'A simple chatbot using API From Gemini, Actually the API is not updated for a long time. maybe next time to improve.',
          tech: 'HTML, CSS, JS Native',
          github: 'https://github.com/alifichwnt/Chatbot-V1',
          demo: 'https://alifichwnt.github.io/Chatbot-V1/'
        }
      ]
    };
  },
    ...
    <article data-page="about">
      <header>
        <div
          ...
          <h4 class="text-base font-normal text-transparent bg-clip-text bg-gradient-to-r from-slate-100 to-blue-400">
