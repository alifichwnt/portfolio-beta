    ...
    return {
      ...
      tech: [
        ...
        },
        {
          id: 6,
          name: 'Codeigniter',
          imageUrl: 'https://logo.svgcdn.com/l/codeigniter.svg',
          status: 'Intermediate'
        },
        {
          id: 7,
        ...
        },
        {
          id: 11,
          name: 'Java',
          imageUrl:'https://logo.svgcdn.com/l/java.svg',
          status: 'Intermediate'
        },
        {
          id: 12,
          name: 'Python',
          imageUrl:'https://logo.svgcdn.com/d/python-original.svg',
          status: 'Intermediate'
        },
        {
          id: 13,
          name: 'R',
          imageUrl:'https://logo.svgcdn.com/d/r-plain.png',
          status: 'Intermediate'
        },
      ],
      tools: [
        ...
        },
        {
          id: 5,
          name: 'PostgreSQL',
          imageUrl: 'https://logo.svgcdn.com/d/postgresql-original.png',
          status: 'Database'
        },
        {
          id: 6,
          name: 'SQLite',
          imageUrl: 'https://logo.svgcdn.com/l/sqlite.png',
          status: 'Database'
        },
        {
          id: 7,
          name: 'VSCode',
          imageUrl: 'https://logo.svgcdn.com/d/vscode-original-wordmark.png',
          status: 'IDE'
        },
        {
          id: 8,
          name: 'APACHE',
          imageUrl: 'https://logo.svgcdn.com/d/apache-original-wordmark.png',
          status: 'IDE'
        },
        {
          id: 9,
          name: 'Colab',
          imageUrl: 'https://logo.svgcdn.com/s/googlecolab-dark.png',
          status: 'IDE'
        },
        {
          id: 10,
          name: 'R Studio',
          imageUrl: 'https://logo.svgcdn.com/d/rstudio-original.png',
          status: 'IDE'
        },
        {
          id: 11,
          name: 'Tableau',
          imageUrl: 'https://logo.svgcdn.com/l/tableau.png',
          status: 'IDE'
        },
      ]
    };
    ...
    <article data-page="about">
      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up" src="/img/about-2.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Alif. I'm currently a final-year student in the Statistical
            Computing (D4) program at Politeknik Statistika STIS. I come from Bekasi City, West Java, with strong
            interests in statistics, data science, machine learning, deep learning, artificial intelligence, and
            full-stack web development.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I focus on data analytics. Sometimes making some website, accidentallly. I always aim to bring a personal and creative touch to every project, ensuring that each
            website clearly communicates its message and identity. Fun fact: I'm actually a lazy coder, but I dream of
            becoming a great programmer. If you're interested in working with me, feel free to reach out!
          </p>
          ...
          <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 dark:text-gray-400 mb-5">
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-blue-400 bg-amber-200 bg-opacity-10': activeTab === 1 }" @click="activeTab = 1">Tech
                Stack</button>
            </li>
            <li class="mr-2">
              <button class="inline-block px-4 py-3 rounded-lg hover:text-white"
                :class="{ 'text-blue-400 bg-amber-200 bg-opacity-10': activeTab === 2 }"
        ...
        <div v-show="activeTab === 1">
          <div class="grid grid-cols-2 gap-4 pb-32 md:grid-cols-3 md:gap-8 xl:grid-cols-4 xl:gap-10 2xl:gap-12">
            <div v-for="item in tech" :key="item.id">
              <div
                class="item-tech flex cursor-pointer items-center gap-2 rounded border border-blue-400 px-2 py-2 hover:bg-amber-200 hover:bg-opacity-10 md:gap-3 lg:px-3">
